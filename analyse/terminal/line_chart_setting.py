...
DEFAULT_CHART_IMAGE_FOLDER_PATH = os.path.join(os.getcwd(), '..', '..', 'chart', 'historylist', 'china', 'line')
DEFAULT_MATPLOTLIB_XTICK_ROTATE_ANGLE = -90

DEFAULT_CHART_IMAGE_EXT = ['.svg', '.png']
DEFAULT_CHART_IMAGE_SIZE = (16, 10)

DEFAULT_CHART_WINDOW_TITLE = '2019-nCoV Chart from 2020-01-11'
DEFAULT_CHART_CAPITAL_FORMAT = '2019-nCoV in China' + r' (https://github.com/cnprogrammer2019/2019-nCoV)'
